...
class complex{
    ...
    friend int calculator:: realsum(complex o1,complex o2);
    friend int calculator::complexsum(complex o1,complex o2);

    //Aliter: Declearing the entire calculater class as friend; -->check in  oops14_class_friend1.cpp
